...
def create_new_sentence(word_list):
  ...
  while(temp.get_next()!=None):
    if(temp.get_data() == "*" and temp.next.get_data()=="/"):
      new_sentence+=" "
      new_sentence+= temp.get_next().get_next().get_data().upper()
      temp = temp.get_next().get_next().get_next()
    elif(temp.get_data() == "*" and temp.get_next().get_data()!="/"):
      new_sentence+=" "
      temp = temp.get_next()
    else:
